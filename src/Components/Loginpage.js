  ...
  return (
    <>
      ...
      <div className='w-screen h-screen md:grid md:grid-cols-3  text-white'>
        ...
        <div className='bg-black centered text-6xl flex '> Board.</div>
        ...
        <div className='bg-gray-200 centered w-full col-span-2 text-black'>
          ...
          <div class="px-4 md:px-0 lg:w-6/12">
            <div class="md:mx-6 md:p-12">
              ...
              {/* Logo*/}
              <div class="">
                <h1 class=" mt-1 pb-1  font-bold text-black text-2xl">
                  Sign In
                </h1>
              ...
              <form className='bg-white rounded-2xl pt-6 px-4 mt-3'>
                ...
                <div class="mb-6 pb-1 pt-1 text-blue-500 grid">
                  ...
                  <button type="button" class="text-white bg-black mt-2 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-4 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
                    <Link to='/dashboard'>
                      Sign In</Link>
                  </button>
                </div>
